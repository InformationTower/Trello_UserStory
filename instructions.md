...
Definition of Done
Taalvoorkeur
Gewenste exportbestemming: Jira, Trello of Azure DevOps
...
Definition of Done
Testbaarheid
Gewenste backlog-tool
Exportvelden voor Jira, Trello of Azure DevOps
...
Gegeven [situatie], wanneer [actie of trigger], dan [verwacht resultaat].
Gegeven [situatie], wanneer [fout of uitzondering], dan [fallback of melding].
Gegeven [systeemvoorwaarde], wanneer [proces start], dan [controleerbaar resultaat].
